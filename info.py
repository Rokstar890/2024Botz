...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5318559054').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tirihak457:rokstar@@cluster0.nqva4qy.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001619665679'))
...
URL = "https://jjjjjjj-00c3a1580631.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://jjjjjjj-00c3a1580631.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://jjjjjjj-00c3a1580631.herokuapp.com/".format(FQDN)
else:
    URL = "https://jjjjjjj-00c3a1580631.herokuapp.com/".format(FQDN)
